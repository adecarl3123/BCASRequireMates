...
namespace BCASRequireMates.Controllers
{
    ...
    public class DocumentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Price,Description")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();
